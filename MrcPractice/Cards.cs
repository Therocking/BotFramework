...
namespace EchoBot
{
    public class Cards
    {
        ...
        {
            var signingCard = new SigninCard
            {
                Text = "BotFramewot Sign-in Card",
        ...
        {
            var reiciptCard = new ReceiptCard
            {
                Title = "John Doe",
        ...
        public static AudioCard GetAudioCard()
        {
            var audioCard = new AudioCard
            {
                ...
                Media = new List<MediaUrl>
                {
                    new MediaUrl()
                    {
                        Url = "https://open.spotify.com/embed/track/3gsCAGsWr6pUm1Vy7CPPob?utm_source=generator",
                    },
                },
                Buttons = new List<CardAction>
                {
